...
from constants.backend.javascript.fastify.base import FASTIFY_GITHUB_ACTIONS_WORKFLOW
from typings.base import ExecutorResponseStatus


class FastifyGitHubActionsBattery(BaseBattery):
    """
    Battery that adds a GitHub Actions CI workflow to a Fastify project.
    ...
    def configure(self, project_path: str, project_name: str, app_name: str) -> None:
        ...
        with open(os.path.join(workflows_dir, 'ci.yml'), 'w', encoding='utf-8') as f:
            f.write(FASTIFY_GITHUB_ACTIONS_WORKFLOW)
