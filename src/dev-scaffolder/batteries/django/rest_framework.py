...
class RestFrameworkBattery(BaseBattery):
    ...
    Adds 'rest_framework' to INSTALLED_APPS before any custom app,
    appends DRF pagination settings, and (when an app name is provided)
    creates a starter serializer, APIView, and URL configuration inside
    the app directory.
    """
