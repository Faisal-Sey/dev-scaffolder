...
# Load .env by searching upward from the current working directory
load_dotenv()
...
def get_venv_directory() -> str:
    ...
    environments it is a venv/ folder inside the current working directory.
    ...
    return str(Path(os.getcwd()) / "venv")