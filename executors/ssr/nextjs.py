...
def generate_ssr_nextjs(project_name="my_nextjs_project", use_typescript=True, use_tailwind=True, use_app_router=True):
    print(f"Generating Next.js SSR project: {project_name}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate Next.js SSR project')
