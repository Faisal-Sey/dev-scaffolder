...
def generate_ssr_astro(project_name="my_astro_project", use_typescript=True, use_tailwind=True, use_app_router=True):
    print(f"Generating Astro SSR project: {project_name}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate Astro SSR project')
    parser.add_argument('--project_name', type=str, default='my_astro_project')
