...
def generate_ssr_sveltekit(project_name="my_sveltekit_project", use_typescript=True, use_tailwind=True, use_app_router=True):
    print(f"Generating SvelteKit SSR project: {project_name}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate SvelteKit SSR project')
    parser.add_argument('--project_name', type=str, default='my_sveltekit_project')
