...
def generate_ssr_nuxtjs(project_name="my_nuxtjs_project", use_typescript=True, use_tailwind=True, use_app_router=True):
    print(f"Generating Nuxt.js SSR project: {project_name}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate Nuxt.js SSR project')
    parser.add_argument('--project_name', type=str, default='my_nuxtjs_project')
